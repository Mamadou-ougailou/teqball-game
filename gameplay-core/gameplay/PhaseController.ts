/**
 * EXTRACTION NOTE: copied verbatim from src/gameplay/PhaseController.ts.
 * Zero imports, zero engine coupling — a pure per-player rally touch state
 * machine (reception → preparation → kick → done).
 */
