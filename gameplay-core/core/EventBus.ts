 ...
 *
 * EXTRACTION NOTE: copied verbatim from src/core/EventBus.ts — it was already
 * 100% view-agnostic (no BabylonJS, no DOM). This is the seam the whole core
 * uses to talk to a UI/VFX/audio layer without depending on it.
 */
