import { IMatchManager } from '../core/types';
 ...
 *
 * EXTRACTION NOTE: logic copied verbatim from src/gameplay/MatchManager.ts.
 * Only the imports changed: `IMatchManager` now comes from the rendering-free
 * `../core/types` (instead of the Babylon-importing `@core/interfaces`), and
 * the EventBus path is relative. No behavioural change.
 */
